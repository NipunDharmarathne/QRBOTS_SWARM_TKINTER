...
def upload_file():
    ...
    if skyc_file_path:
        ...
        for i, position in enumerate(drone_home_positions, 1):
            ...
            map_widget.set_marker(lat, lon, icon=location_image, icon_anchor="s", text=i, text_color="#000000", font="Tahoma 6 bold")
...
marker_1 = map_widget.set_marker(0, 0, icon=location_image)
marker_1.set_text("1") 
...
def listen_func():
    ...
    while True:
        ...
        if msg1 is not None:
            # print(msg1)
            print(msg1.lat/10000000.0, msg1.lon/10000000.0)
            marker_1.set_position(msg1.lat/10000000.0, msg1.lon/10000000.0)
