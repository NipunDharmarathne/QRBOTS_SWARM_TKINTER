...
# marker_1 = map_widget.set_marker(0, 0, icon=location_image, icon_anchor="s", text=1, text_color="#000000", font="Tahoma 6 bold")
# marker_2 = map_widget.set_marker(0, 0, icon=location_image, icon_anchor="s", text=2, text_color="#000000", font="Tahoma 6 bold")
