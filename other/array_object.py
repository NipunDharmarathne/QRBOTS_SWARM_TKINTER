...
for i in range(5):
    ...
    button = tk.Button(frame, text="DISARM", command=lambda label=label: button_click(label))
    button.pack(side="left")

    button = tk.Button(frame, text="LIGHT", command=lambda label=label: button_click(label))
    button.pack(side="left")

    button = tk.Button(frame, text="TAKE OFF", command=lambda label=label: button_click(label))
    button.pack(side="left")    
