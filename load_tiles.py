...
top_left_position = (7.2598923, 80.59889)
bottom_right_position = (7.2562524, 80.5994693)
zoom_min = 0
zoom_max = 21
...
loader = tkintermapview.OfflineLoader(path=database_path, tile_server="https://mt0.google.com/vt/lyrs=m&hl=en&x={x}&y={y}&z={z}&s=Ga", max_zoom=21)
